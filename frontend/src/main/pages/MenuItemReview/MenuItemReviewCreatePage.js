...
export default function MenuItemReviewCreatePage({storybook=false}) {
  ...
  const onSuccess = (menuItemReview) => {
    toast(`New review Created - itemId: ${menuItemReview.itemId} reviewerEmail: ${menuItemReview.reviewerEmail} dateReviewed: ${menuItemReview.dateReviewed} stars: ${menuItemReview.stars} comments: ${menuItemReview.comments}`);
  }
