...
function RecommendationRequestForm({ initialContents, submitAction, buttonLabel = "Create" }) {
    ...
    //const isodate_regex = /(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d(\.\d+)?)/i;
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.requesterEmail?.type === 'pattern' && 'Requester Email must in the form of an email.'}
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.professorEmail?.type === 'pattern' && 'Professor Email must in the form of an email.'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
