...
describe("HelpRequestIndexPage tests", () => {
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/helprequest/all").reply(200, helpRequestFixtures.threeRequests);
        axiosMock.onDelete("/api/helprequest").reply(200, "Help Request with id 2 was deleted");
        ...
        // assert
        await waitFor(() => { expect(mockToast).toBeCalledWith("Help Request with id 2 was deleted") });
