...
describe("UserTable tests", () => {
    ...
    const expectedHeaders = ["id", "Requester Email", "Explanation", "Request Time", "Table or Breakout Room", "Team ID", "Solved"];
    const expectedFields = ["id", "requesterEmail", "explanation", "requestTime", "tableOrBreakoutRoom", "teamId", "solved"];
  ...
  test("Delete button calls delete callback", async () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-explanation`)).toHaveTextContent("Fail to build");
