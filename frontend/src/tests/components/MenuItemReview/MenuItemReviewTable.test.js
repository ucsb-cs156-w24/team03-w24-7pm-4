...
describe("MenuItemReviewTable tests", () => {
  ...
  test("Has the expected column headers and content for ordinary user", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-reviewerEmail`)).toHaveTextContent("wesley@ucla.edu");

    expect(screen.getByTestId(`${testId}-cell-row-1-col-id`)).toHaveTextContent("2");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-reviewerEmail`)).toHaveTextContent("wesley@ucsd.edu");
